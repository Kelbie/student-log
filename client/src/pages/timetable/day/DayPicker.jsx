    ...
    <div {...props}>
      <div className="top">
        <DateRangePicker
          ...
          startDateOffset={day => day.startOf('week').add(12, 'hours')}
        ...
        <div className="current-day">
          {date.format(new Date(props.date).addDays(props.currentStep - 2), 'YYYY-MM-DD')}
        </div>
        <Button
          type="button"
          active
...
DayPicker = styled(DayPicker)`
  ...
  .CalendarDay__selected {
    ...
    border: none;
    background: ${props =>
      `linear-gradient(to bottom right, ${props.theme.PRIMARY_COLOR}, ${props.theme.SECONDARY_COLOR})`};
    &:hover {
      border: none;
      background: ${props =>
        `linear-gradient(to bottom right, ${props.theme.PRIMARY_COLOR}, ${props.theme.SECONDARY_COLOR})`};
  ...
  .CalendarDay__selected_span {
    background: ${props =>
      `linear-gradient(to bottom right, ${desaturate(0.2, props.theme.PRIMARY_COLOR)}, ${desaturate(
        0.2,
  ...
  .DayPickerKeyboardShortcuts_show__bottomRight::before {
    border-right-color: ${props => props.theme.SECONDARY_COLOR} !important;
  }

  .DateInput_input__focused {
    border-bottom-color: ${props => props.theme.SECONDARY_COLOR} !important;
  }
